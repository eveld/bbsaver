...
struct Uniforms {
    ...
    margin_top: f32,           // vertical offset in pixels to center art
    _pad: f32,
}
...
fn vs_main(
    ...
    let cell_y = (f32(instance.grid_pos.y) - uniforms.scroll_offset) * uniforms.cell_size.y + uniforms.margin_top;
